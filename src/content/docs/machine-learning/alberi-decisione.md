...
Per mettere in pratica le conoscenze acquisite in questa unità sugli alberi di decisione e sulle Random Forest, consulta la sezione pratica del manuale:

*   **Teoria e Calcolo (Carta e Penna)**:
    *   [Esercizi Teorici: Alberi di Decisione e Random Forest](file:///f:/Progetti%20Github/Manuale_Libero_Online_di_Informatica/Repository-manuale/src/content/docs/machine-learning/esercizi-teorici-alberi-decisione.md)
*   **Esercitazione in Python (Scikit-Learn)**:
    *   [Laboratorio: Alberi di Decisione](file:///f:/Progetti%20Github/Manuale_Libero_Online_di_Informatica/Repository-manuale/src/content/docs/machine-learning/laboratorio-alberi-decisione.md)
    *   [Download Notebook Jupyter: unita3_alberi_decisione.ipynb](/manuale-libero-online-di-informatica/assets/codice/python/unita3_alberi_decisione.ipynb)
