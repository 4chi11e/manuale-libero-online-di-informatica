...
<div id="esercizi-subnetting">
    ...
    <div class="soluzione-container">
        ...
        <div class="soluzione soluzione-completa" id="es01-completa">
            ...
            <p>
                ci saranno 3 bit dedicati alle subnet e 5 tiservati agli host per un totale di:<br>
    ...
    <div class="soluzione-container">
        ...
        <div class="soluzione soluzione-completa" id="es03-completa">
            <p>
                La soluzione di seguito è errata perchè aggiunge solo 2 bit alla subnet-mask invece che 3
            </p>
            <p>
    ...
    <div class="soluzione-container">
        ...
        <div class="soluzione soluzione-semplice" id="es08-semplice">
            <p>[ 1°host della 30a sub = 150.12.116.1 | ultimo h della 30a sub = 150.12.119.25 <br>&nbsp
                1°host della 50a sub = 150.12.200.1 | ultimo h della 50a sub = 150.12.203.254 ]</p>
        </div>
    </div>
