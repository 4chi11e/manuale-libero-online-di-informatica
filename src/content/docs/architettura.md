...
<div class="thumbnail tright mb-2">
  <img src="/manuale-libero-online-di-informatica/assets/images/architettura/schema-cpu.png" class="modal__opener" aprire="#schema-cpu">
...
<div id="schema-cpu" class="modal">
  <div class="modal__content">
    ...
    <div class="modal__content__img-container">   
      <img src="/manuale-libero-online-di-informatica/assets/images/architettura/schema-cpu.png">
    </div>
    <p>Schema della struttura interna di una CPU</p>
  </div>
</div>
